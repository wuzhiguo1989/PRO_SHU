...
// 36v
//static code u8 const battery_level[4] ={32,  34,  36,  38};
// 48v
static code u8 const battery_level[4] ={42,  44,  47,  49};
...
void jt17467pqw_set_speed(const u16 speed)
{
  ...
  u32 speed_mile = speed;
  speed_mile = (speed_mile * 62) / 100;
  jt17467pqw_set_speed_unit_mps(1);
  if(speed_mile < 100)
    jt17467pqw_set_digit(FIRST_NOT_DISPLAY, SPEED_DECADE_ID);
  else
    jt17467pqw_set_digit(speed_mile/100, SPEED_DECADE_ID);
  jt17467pqw_set_digit((speed_mile%100/10) , SPEED_UNIT_ID);
  jt17467pqw_set_speed_decimal_point(1);
  jt17467pqw_set_digit(speed_mile%10, SPEED_DECIMAL_ID);
...
void jt17467pqw_set_mileage(u16 mileage)
{
  ...
  u32 mileage_mile = mileage * 62 / 100;
  jt17467pqw_set_mileage_unit_mile(1);
  
  if(mileage_mile / 1000)
    mileage_mile = mileage_mile - (mileage_mile / 1000 * 1000);

  if(mileage_mile < 100)
    jt17467pqw_set_digit(FIRST_NOT_DISPLAY, MILEAGE_DECADE_ID);
  else
    jt17467pqw_set_digit(mileage_mile/100, MILEAGE_DECADE_ID);
  jt17467pqw_set_digit(mileage_mile % 100 / 10, MILEAGE_UNIT_ID);
  jt17467pqw_set_mileage_decimal_point(1);
  jt17467pqw_set_digit(mileage_mile % 10, MILEAGE_DECIMAL_ID);
}
...
void jt17467pqw_set_mileage_total(const u32 mileage_total)
{
  ...
  u32 mileage_total_mile =  mileage_total * 62 / 100;
  jt17467pqw_set_mileage_total_unit_mile(1);
  if(mileage_total_mile < 100000)
  {
    if(mileage_total_mile < 10000)
      jt17467pqw_set_digit(FIRST_NOT_DISPLAY, MILEAGE_TOTAL_THOUSAND_ID);
    else
      jt17467pqw_set_digit(mileage_total_mile/10000 , MILEAGE_TOTAL_THOUSAND_ID);
    if(mileage_total_mile < 1000)
      jt17467pqw_set_digit(FIRST_NOT_DISPLAY, MILEAGE_TOTAL_HUNDRED_ID);
    else
      jt17467pqw_set_digit(mileage_total_mile % 10000 / 1000, MILEAGE_TOTAL_HUNDRED_ID);
    if(mileage_total_mile < 100)
      jt17467pqw_set_digit(FIRST_NOT_DISPLAY, MILEAGE_TOTAL_DECADE_ID);
    else
      jt17467pqw_set_digit(mileage_total_mile % 1000 / 100, MILEAGE_TOTAL_DECADE_ID); 
    jt17467pqw_set_digit(mileage_total_mile % 100 / 10 , MILEAGE_TOTAL_UNIT_ID);
    jt17467pqw_set_mileage_total_decimal_point(1);
    jt17467pqw_set_digit(mileage_total_mile % 10 , MILEAGE_TOTAL_DECIMAL_ID);
  }
  else
  {
    jt17467pqw_set_digit(mileage_total_mile/100000 , MILEAGE_TOTAL_THOUSAND_ID);
    jt17467pqw_set_digit(mileage_total_mile % 100000 / 10000, MILEAGE_TOTAL_HUNDRED_ID);
    jt17467pqw_set_digit(mileage_total_mile % 10000 / 1000, MILEAGE_TOTAL_DECADE_ID); 
    jt17467pqw_set_digit(mileage_total_mile % 1000 / 100 , MILEAGE_TOTAL_UNIT_ID);
    jt17467pqw_set_mileage_total_decimal_point(0);
    jt17467pqw_set_digit(mileage_total_mile % 100 / 10 , MILEAGE_TOTAL_DECIMAL_ID);
  }
}
