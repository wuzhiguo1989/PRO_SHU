...
#ifndef	_STC15W4K32S4_H
#define	_STC15W4K32S4_H
...
#define		S3_MODE0()			S3_8bit()
#define 	S3_MODE1()			S3_9bit()
#define		S3_RX_EN()			S3_RX_Enable()
#define		TI3					(S3CON & (1<<1)) != 0
#define		RI3					(S3CON & (1<<0)) != 0
#define		SET_TI3()			S3CON |=  (1<<1)
#define		CLR_TI3()			S3CON &= ~(1<<1)
#define		CLR_RI3()			S3CON &= ~(1<<0)
#define		S3TB8_SET()			S3CON |=  8
#define		S3TB8_CLR()			S3CON &= ~8
#define 	S3_Int_Enable()		IE2	  |= 8
#define		S3_Int_Disable()	IE2   &= ~8	
...
#define		S4_MODE0()			S4_8bit()
#define 	S4_MODE1()			S4_9bit()
#define		S4_RX_EN()			S4_RX_Enable()
#define		TI4					(S4CON & (1<<1)) != 0
#define		RI4					(S4CON & (1<<0)) != 0
#define		SET_TI4()			S4CON |=  (1<<1)
#define		CLR_TI4()			S4CON &= ~(1<<1)
#define		CLR_RI4()			S4CON &= ~(1<<0)
...
#define 	Timer3_InterruptEnable()	IE2  |=  (1<<5)	//允许Timer2中断.
#define 	Timer3_InterruptDisable()	IE2  &= ~(1<<5)	//禁止Timer2中断.
#define 	Timer4_InterruptEnable()	IE2  |=  (1<<6)	//允许Timer2中断.
#define 	Timer4_InterruptDisable()	IE2  &= ~(1<<6)	//禁止Timer2中断.	
...
#define 	T3_pulseP04_enable()		T4T3M |= 1
#define 	T3_pulseP04_disable()		T4T3M &= ~1
#define 	T4_pulseP06_enable()		T4T3M |= (1<<4)
#define 	T4_pulseP06_disable()		T4T3M &= ~(1<<4)
...
#define 	Timer3_Load(n)		TH3 = (n) / 256, 	TL3 = (n) % 256	
#define 	Timer4_Load(n)		TH4 = (n) / 256,	TL4 = (n) % 256
...
#define		Timer3_Load_us(n)	TH3=(65536-MainFosc_KHZ*(n)/1000)/256,TL3=(65536-MainFosc_KHZ*(n)/1000)%256
#define		Timer4_Load_us(n)	TH4=(65536-MainFosc_KHZ*(n)/1000)/256,TL4=(65536-MainFosc_KHZ*(n)/1000)%256
