...
void get_param_set_from_screen()
{
	...
	TX_write2buff(COM[COM2_ID], 0x0A);
}
...
void no_oprate_callback()
{
	...
	if(page == PAGE_ADMIN_SETTING1 || page == PAGE_ADMIN_SETTING2 || page == PAGE_ADMIN_SETTING3 || page == PAGE_ADMIN_SETTING4 || page == PAGE_GUEST_SETTING1 || page == PAGE_GUEST_SETTING2)
		display_all_para(INDEX_FOR_ADMIN_SET);
