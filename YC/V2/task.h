...
extern count_down_t xdata spray_wash;
extern count_down_t xdata spray_wash_between;
extern count_down_t xdata spray_wash_before_stop;
extern count_down_t xdata spray_wash_between_before_stop;
extern count_down_t xdata feed_intercept;
...
#define reload_spray_wash_between() count_down_reload(&spray_wash_between, time_spray_wash_between_set, 0)
// #define reload_spray_wash_stop() count_down_reload(&spray_wash_stop, 1, 0)

#define reload_spray_wash_before_stop() count_down_reload(&spray_wash_before_stop, time_spray_wash_before_stop_set/10,time_spray_wash_before_stop_set % 10 * COUNTER_PER_100MS)
#define reload_spray_wash_between_before_stop() count_down_reload(&spray_wash_between_before_stop, time_spray_wash_between_before_stop_set, 0)

#define reload_feed_intercept_stop() count_down_reload(&feed_intercept, time_feed_intercept_set, 0)
