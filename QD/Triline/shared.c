...
// Default is STEADY
volatile disp_t display_mode_set = steady_on, display_mode_logic = steady_on;
//volatile disp_t display_mode_set = chasing_flash, display_mode_logic = chasing_flash;
