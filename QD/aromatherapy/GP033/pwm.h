...
#define PWMCLOCK            PwmClk_1T  //不分频
#define PWM_FIXED_FREQ      1000        // 800KHz


#define PWM_MAX_CYCLE       0x8000
// FIXED_CYCLE < PWM_MAX_CYCLE
#define PWM_FIXED_CYCLE     (MAIN_Fosc / PWM_FIXED_FREQ)
// #define PWM_FIXED_CYCLE     29
