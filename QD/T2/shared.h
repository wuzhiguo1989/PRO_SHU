...
extern volatile u8 	Tx2Buf0[TX_PLOAD_WIDTH];	 // 
extern volatile u8 	Tx2Buf1[TX_PLOAD_WIDTH];	 // 
extern volatile u8 	Tx2Buf2[TX_PLOAD_WIDTH];	 // 
extern volatile u8  Rx2Buf[RX_PLOAD_WIDTH];