...
{
    if(hour_param > 23 || minute_param > 59)
        return ;
		else{
...
{
    if(param == 1){
        bluetooth_send_command("AT+A1ON\r\n");
    } else if (param == 2){
        bluetooth_send_command("AT+A1OFF\r\n");
    } else if (param == 3){
        bluetooth_send_command("AT+A2ON\r\n");
    } else if (param == 4){
        bluetooth_send_command("AT+A2OFF\r\n");
    } else {
        return ;
    }
}
