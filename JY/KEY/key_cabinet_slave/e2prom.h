...
#define ADDRESS_FOR_TIMESTAMP 0xEC00
...
#define ADDRESS_FOR_COUNTER_READ_A_AND_B 0xF200
#define ADDRESS_FOR_COUNTER_WRITE_A 0xF204
#define ADDRESS_FOR_COUNTER_CHANGE_BLE_NAME 0xF208
