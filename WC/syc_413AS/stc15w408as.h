...
// eg. spiral_cycle = 2 ^ x, cnt: 0, 1, 2, ... , x-1 , 0, 1 ...
#define spiral_increase_c(cnt, spiral_cycle) ++cnt; cnt %= spiral_cycle
#define spiral_increase_q(cnt, spiral_cycle) ++cnt; cnt &= (spiral_cycle - 1)
...
#define set_quasi_bidirectional_on0(pin) 		low_at_bit(P0M1, pin); low_at_bit(P0M0, pin)
#define set_push_pull_output_on0(pin)			low_at_bit(P0M1, pin); high_at_bit(P0M0, pin)
#define set_input_only_on0(pin)					high_at_bit(P0M1, pin); low_at_bit(P0M0, pin)
#define set_open_drain_on0(pin)					high_at_bit(P0M1, pin); high_at_bit(P0M0, pin)

#define set_quasi_bidirectional_on1(pin) 		low_at_bit(P1M1, pin); low_at_bit(P1M0, pin)
#define set_push_pull_output_on1(pin)			low_at_bit(P1M1, pin); high_at_bit(P1M0, pin)
#define set_input_only_on1(pin)					high_at_bit(P1M1, pin); low_at_bit(P1M0, pin)
#define set_open_drain_on1(pin)					high_at_bit(P1M1, pin); high_at_bit(P1M0, pin)

#define set_quasi_bidirectional_on2(pin) 		low_at_bit(P2M1, pin); low_at_bit(P2M0, pin)
#define set_push_pull_output_on2(pin)			low_at_bit(P2M1, pin); high_at_bit(P2M0, pin)
#define set_input_only_on2(pin)					high_at_bit(P2M1, pin); low_at_bit(P2M0, pin)
#define set_open_drain_on2(pin)					high_at_bit(P2M1, pin); high_at_bit(P2M0, pin)
...
#define set_push_pull_output_on5(pin)			low_at_bit(P5M1, pin); high_at_bit(P5M0, pin)
